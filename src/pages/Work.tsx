      ...
      <section className="pt-32 pb-20">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h1 className="text-6xl md:text-8xl font-light text-architectural mb-8">Clientes

              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl">Tu Oficina IA en 4 pasos. Visualizamos la evolución desde el 
