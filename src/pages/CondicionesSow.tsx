...
const CondicionesSow = () => {
  ...
  const tocSections = [
    ...
    { id: "contexto", label: "2. Contexto del Proyecto y Necesidades del Cliente" },
    { id: "alcance", label: "3. Alcance de los Servicios" },
    { id: "propiedad", label: "4. Propiedad Intelectual y Confidencialidad" },
    { id: "economicas", label: "5. Condiciones Económicas y Costes de Terceros" },
    { id: "responsabilidad", label: "6. Responsabilidad y Naturaleza de la IA" },
    { id: "gestion", label: "7. Gestión y Control de Cambios" },
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-start justify-between mb-12">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-light text-[hsl(0_0%_10%)] leading-tight">
              ...
              <button
                onClick={handlePrint}
                className="print:hidden flex items-center gap-2 text-xs font-medium tracking-widest uppercase text-[hsl(0_0%_50%)] hover:text-[hsl(0_0%_10%)] transition-colors duration-300 mt-2 border border-[hsl(0_0%_90%)] rounded px-3 py-2"
              >
            ...
            {/* Table of Contents */}
            <nav className="bg-[hsl(0_0%_96%)] rounded-lg p-6 mb-16">
              ...
              <ol className="space-y-2">
                {tocSections.map((section) => (
                  <li key={section.id}>
                    <a
                      href={`#${section.id}`}
                      className="text-sm text-[hsl(0_0%_30%)] hover:text-[hsl(0_0%_0%)] transition-colors duration-200"
                    >
                      {section.label}
                    </a>
                  </li>
            ...
            {/* Legal Content */}
            <div className="space-y-16 text-[hsl(0_0%_20%)] leading-relaxed">

              {/* Section 1 */}
              <section id="introduccion">
                <h2 className="text-2xl font-semibold text-[hsl(0_0%_10%)] mb-6">
              ...
              <section id="contexto">
                <h2 className="text-2xl font-semibold text-[hsl(0_0%_10%)] mb-6">
                  2. Contexto del Proyecto y Necesidades del Cliente
                </h2>
                <h3 className="text-lg font-semibold text-[hsl(0_0%_10%)] mb-4">
              ...
              <section id="alcance">
                ...
                <p className="text-[15px] mb-4">
                  El Cliente contrata a El Prestador para la realización de servicios de <strong>consultoría especializada en Inteligencia Artificial, formación y automatización de casos de uso</strong>. La descripción detallada de las tareas, fases, entregables y plazos se especifica en el presente SOW (Skyview_Master_SOW_v0.2), el cual forma parte integrante y vinculante del Contrato de Prestación de Servicios.
                </p>
              ...
              <section id="economicas">
                <h2 className="text-2xl font-semibold text-[hsl(0_0%_10%)] mb-6">
                  5. Condiciones Económicas y Costes de Terceros
                </h2>
                <h3 className="text-lg font-semibold text-[hsl(0_0%_10%)] mb-4">
                  5.1. Honorarios
                </h3>
                ...
                <div className="bg-[hsl(0_0%_96%)] border-l-4 border-[hsl(0_0%_70%)] p-4 rounded-r mb-6">
                  <p className="text-[15px]">
              ...
              <section id="responsabilidad">
                <h2 className="text-2xl font-semibold text-[hsl(0_0%_10%)] mb-6">
                  6. Responsabilidad y Naturaleza de la IA
                </h2>
                <h3 className="text-lg font-semibold text-[hsl(0_0%_10%)] mb-4">
                ...
                <div className="bg-[hsl(0_0%_96%)] border-l-4 border-[hsl(0_0%_10%)] p-4 rounded-r mb-6">
                  <p className="text-[15px]">
