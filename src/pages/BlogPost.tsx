...
const BlogPost = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        titleKey="seo.blogPost.title"
        descriptionKey="seo.blogPost.description"
        routeKey="blogPost"
        breadcrumbs={[
          { name: t("nav.home", "Home"), routeKey: "home" },
          { name: t("nav.resources"), routeKey: "blog" },
          { name: post.title, routeKey: "blogPost" },
        ]}
      />
      <Navigation />
                  ...
                  __html: DOMPurify.sanitize(
                    post.content
                      ...
                      .map(line => {
                        ...
                        if (line.startsWith('## ')) return `<h2 class="text-2xl md:text-3xl font-light text-architectural mb-6 mt-10">${line.substring(3)}</h2>`;
            ...
            <div className="mt-16 pt-8 border-t border-border">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{t("blogPage.authorRole")}</p>
                </div>
              </div>
            </div>
